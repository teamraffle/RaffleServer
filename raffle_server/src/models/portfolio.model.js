...
=======
    ...
    if (rows[0] == undefined) {
      ...
      return total; //TODO 양식맞추기
>>>>>>> b13ac97b0e61488e714b4846d23a7a011cd68ce8
    }
  } finally {
    if (conn) conn.release();
  }
