...
const get_ranking = async (query) => {
  ...
  try {
    ...
    const count_query = 'SELECT b.nickname,a.wallet_address,a.create_timestamp,a.est_market_value,a.earnings_rate,a.av_holding_period  FROM tb_portfolio_eth as a  INNER JOIN tb_user AS b ON a.wallet_address=b.address ORDER BY a.av_holding_period DESC LIMIT ? OFFSET ?;';
